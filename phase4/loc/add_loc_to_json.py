...
Usage:
    python3 add_loc_to_json.py -i classify_result.json -d 1k_puml_sample -o output.json
"""
...
Examples:
  ...
  python3 add_loc_to_json.py -i classify_result.json -d ../phase3/puml -o output.json -v

  # Multiple search directories
  python3 add_loc_to_json.py -i classify.json -d dir1 -d dir2 -d dir3 -o output.json
        """
    )

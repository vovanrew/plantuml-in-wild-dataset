#!/usr/bin/env python3
"""
Figure 3: Element Type Distribution

Creates an publication-quality horizontal bar chart showing the top 15
element types used in PlantUML diagrams.
"""
...
# Paths
OUTPUT_PNG = Path(__file__).parent / 'fig3_element_types.png'
OUTPUT_TIFF = Path(__file__).parent / 'fig3_element_types.tif'
OUTPUT_PDF = Path(__file__).parent / 'fig3_element_types.pdf'
...
def create_chart(by_type, total_elements):
    ...
    ax.annotate(f'Total: {total_elements:,} elements',
                xy=(0.98, 0.02),
...
def main():
    ...
    print(f"Showing top {TOP_N} types")

    print("\nCreating chart...")
    fig = create_chart(by_type, total_elements)

...
OUTPUT_PNG = Path(__file__).parent / "fig5_confusion_matrix.png"
OUTPUT_TIFF = Path(__file__).parent / "fig5_confusion_matrix.tif"
OUTPUT_PDF = Path(__file__).parent / "fig5_confusion_matrix.pdf"
